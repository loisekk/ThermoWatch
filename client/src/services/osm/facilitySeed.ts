...
/**
 * Seed industrial registry — stands in for the OSM Overpass extraction
 * (industrial / power / man_made=flare tags). Replace with services/osm
 * Overpass client in production; schema is identical.
 */
export const FACILITIES: Facility[] = [
  ...
  { id: 'F-004', name: 'Tata Steel Jamshedpur', subtype: 'steel', lat: 22.8, lon: 86.2, hazard: 'G-III' },
  ...
  { id: 'F-007', name: 'Vapi Chemical Zone', subtype: 'chemical', lat: 20.37, lon: 72.9, hazard: 'G-III' },
  ...
  { id: 'F-010', name: 'Satna Cement Works', subtype: 'cement', lat: 24.6, lon: 80.83, hazard: 'G-II' },
  { id: 'F-011', name: 'Gulbarga Cement Unit', subtype: 'cement', lat: 17.33, lon: 76.83, hazard: 'G-II' },
  { id: 'F-012', name: 'Nalco Angul Smelter', subtype: 'smelter', lat: 20.85, lon: 85.1, hazard: 'G-III' },
  { id: 'F-013', name: 'Singrauli NTPC Station', subtype: 'power_plant', lat: 24.05, lon: 82.7, hazard: 'G-II' },
  { id: 'F-014', name: 'Chandrapur Thermal PS', subtype: 'power_plant', lat: 19.85, lon: 79.3, hazard: 'G-II' },
];
